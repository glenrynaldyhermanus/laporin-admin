...
class NewTaskDialogWidget extends StatefulWidget {
  const NewTaskDialogWidget({super.key});

  @override
  _NewTaskDialogWidgetState createState() => _NewTaskDialogWidgetState();
}

class _NewTaskDialogWidgetState extends State<NewTaskDialogWidget> {
  late NewTaskDialogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewTaskDialogModel());
